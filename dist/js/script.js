...
function cards() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_4__["getResources"])('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (event) {
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries())); // const object = {};
    ...
    function showThanksModal(message) {
      ...
      Object(_modal__WEBPACK_IMPORTED_MODULE_7__["openModal"])('.modal');
...
function slider(_ref) {
  ...
  var slidesWrapperWidth = slidesWrapper.clientWidth;
  var slideIndex = 1;
  var slideOffset = 0;
  var dots = [];
  ...
  function showIndicators() {
    ...
    for (var i = 0; i < slides.length; i++) {
      var sliderDot = document.createElement('li');
    ...
    dots.forEach(function (dot) {
      dot.addEventListener('click', function (e) {
        var slideTo = e.target.getAttribute('data-target');
        slideIndex = slideTo;
        slideOffset = slidesWrapperWidth * (slideTo - 1);
        slidesField.style.transform = "translateX(-".concat(slideOffset, "px)");
        counter();
        dotsOpacity(dots);
      });
    });
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  var tabsWrapper = document.querySelector(tabsSelector),
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])('.tabheader__items', '.tabheader__item', '.tabcontent', 'tabheader__item_active');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-modal]', '.modal');
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2021-05-20');
